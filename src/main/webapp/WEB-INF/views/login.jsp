...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/AdminLTE.min.css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/style.css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/assets/font-awesome/4.5.0/css/font-awesome.min.css" />

<!-- text fonts -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/assets/css/fonts.googleapis.com.css" />
<!-- ace styles -->
...
<script src="${pageContext.request.contextPath}/resource/bufferGrid/jquery.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/bufferGrid/w2ui.min.js"></script>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/bufferGrid/w2ui.min.css" />
...
<body class="login-layout blur-login">
							...
							<div class="center">
								<h1>
									<a href="${pageContext.request.contextPath}/">
										...
										<img style="margin-right:10px; -moz-box-shadow:0px 1px 3px 3px #ccc; -webkit-box-shadow:0px 1px 3px 3px #ccc; box-shadow:0px 1px 3px 3px #ccc; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px;" src="resource/images/logo.jpg">
									</a>
								</h1>
								<h3 class="blue" id="id-company-text">&copy; Vehicle Management System</h3>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<c:if test="${not empty error}">				
												<center><p style="color:red;">The username or password you entered is incorrect</p> </center>
											</c:if>											
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<fieldset>
												...
												<strong class="hide red" id="message"></strong>
	...
	<!-- basic scripts -->
	<!--[if !IE]> -->
		<script src="${pageContext.request.contextPath}/resource/assets/js/jquery-2.1.4.min.js"></script>
	...
	<script>
		$( document ).ready( function() {
			$('#forgetpassbtn').click( function() {
				...
				//alert(email);
				$.ajax({
					url : contextPath + '/auth/forgetPassword.do',
					data : "{email:" + email + "}",
					contentType : "application/json",
					success : function(data) {
						//var gap = JSON.parse(data);
						if( data == 'Invalid E-mail address' ) {
							$('#message').removeClass('hide green').addClass('red').text(data);
							$('#forgetpassbtn').removeAttr("disabled");
						}
						else if( data.startsWith("Sent a link to") ) {
							$('.alert.alert-success').removeClass('hide').html(data);
